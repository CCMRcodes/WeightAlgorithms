...
#            is found to be above sd_threshold, then measurement is
...
#' @param sd_threshold numeric scalar to be multiplied by the \code{meanMeasures}
...
littman <- function(df,
  ...
  # calc SD threshold
  DT[, `:=`(SD_threshold_ = sd_threshold * meanMeasures), by = id][]
